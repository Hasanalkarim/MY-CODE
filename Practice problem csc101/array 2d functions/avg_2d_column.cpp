...
void avg_2d_column(float[10][10],int ,int,float[]); //add 2d column and put it into y array
...
void avg_2d_column(float x[10][10], int row,int column , float y[10]){
